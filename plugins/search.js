...
cmd({
        ...
        let esana = await fetchJson(`https://legend-army-api-nimesh-official.koyeb.app/api/news/esana-news?apikey=nima2008`);

        const caption = `*ʙʟᴀᴄᴋ-ᴅʀᴀɢᴏɴ ᴇꜱᴀɴᴀ ɴᴇᴡꜱ*
        
*ᴛɪᴛʟᴇ :* ${esana.result.title}
        
*ᴘᴜʙʟɪꜱʜᴇᴅ :* ${esana.result.published}
        
*ᴅᴇꜱᴄʀɪᴘᴛɪᴏɴ :* ${esana.result.description}
        
*ᴜʀʟ :* ${esana.result.url}
        
*ʙʟᴀᴄᴋ-ᴅʀᴀɢᴏɴ ᴡʜᴀᴛꜱᴀᴘᴘ ʙᴏᴛ*`
           
        Void.sendMessage(citel.chat, { image: { url: esana.result.image }, caption: caption  }, { quoted: citel  });
